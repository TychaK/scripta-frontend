...
!function (e, t, n) {
    ...
    function g(e, t, o, i) {
        ...
        for (p = e.length, d = 0; p > d; d++) if (m = e[d], h = R.style[m], c(m, "-") && (m = u(m)), R.style[m] !== n) {
    ...
    function y(e, t, n, o, i) {
        var a = e.charAt(0).toUpperCase() + e.slice(1), s = (e + " " + B.join(a + " ") + a).split(" ");
    ...
    var k = "Moz O ms Webkit", P = S._config.usePrefixes ? k.toLowerCase().split(" ") : [];
    S._domPrefixes = P;
    var z;
    !function () {
    ...
    S.prefixedCSSValue = L, Modernizr.addTest("webanimations", "animate" in l("div")), Modernizr.addTest("webgl", function () {
        var t = l("canvas"), n = "probablySupportsContext" in t ? "probablySupportsContext" : "supportsContext";
